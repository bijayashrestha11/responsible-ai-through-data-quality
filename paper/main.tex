...
Equally central is where the signal \emph{fails}: across three datasets we find it holds on Adult, reverses on COMPAS, and vanishes
...
Adult with all else fixed). This is itself the
adjudication of the conflicting prior results~\cite{bhatti2025,min2025}. We are careful not to
